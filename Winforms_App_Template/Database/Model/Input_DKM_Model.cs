...
namespace Winforms_App_Template.Database.Model
{
    public sealed class Dieu_kien_may_Model
    {
        ...
        public string val51 { get; init; } = "";                 // Tên điều kiện máy
        public string val52 { get; init; } = "";                 // Tên điều kiện máy
        public string val53 { get; init; } = "";                 // Tên điều kiện máy
        public string val54 { get; init; } = "";                 // Tên điều kiện máy
    }
}
